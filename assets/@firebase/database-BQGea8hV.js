import{_ as vi,r as mn,a as Ci,g as Ei,b as Ii,S as Ti}from"./app-CHo1YO-Z.js";import{C as wi}from"./component-BFrR9VSR.js";import{x as f,y as k,z as Mt,A as Y,B as he,C as Be,G as Si,S as Ni,H as Ri,I as De,J as Dt,D as Ot,q as bi,K as ki,L as xi,r as yn,c as ts,e as Pi,h as _e,M as Ai,N as it,O as Mi,P as Di,Q as Oi,d as Li,R as Fi,m as ns,p as Wi,u as Ui}from"./util-D3hzesmL.js";import{L as qi,a as Gi}from"./logger-CNz1B4Yj.js";var vn={};const Cn="@firebase/database",En="1.0.19";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Vi(e)}}catch{}return new Bi},X=is("localStorage"),Yi=is("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const e of this.listens.values())for(const t of e.values())this.sendListen_(t);for(let e=0;e<this.outstandingPuts_.length;e++)this.outstandingPuts_[e]&&this.sendPut_(e);for(;this.onDisconnectRequestQueue_.length;){const e=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(e.action,e.pathString,e.data,e.onComplete)}for(let e=0;e<this.outstandingGets_.length;e++)this.outstandingGets_[e]&&this.sendGet_(e)}sendConnectStats_(){const e={};let t="js";e["sdk."+t+"."+ss.replace(/\./g,"-")]=1,ts()?e["framework.cordova"]=1:Pi()&&(e["framework.reactnative"]=1),this.reportStats(e)}shouldReconnect_(){const e=Qe.getInstance().currentlyOnline();return yn(this.interruptReasons_)&&e}}H.nextPersistentConnectionId_=0;H.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return v(this._path)?null:Rs(this._path)}get ref(){return new j(this._repo,this._path)}get _queryIdentifier(){const e=Fn(this._queryParams),t=Lt(e);return t==="{}"?"default":t}get _queryObject(){return Fn(this._queryParams)}isEqual(e){if(e=_e(e),!(e instanceof pn))return!1;const t=this._repo===e._repo,s=qt(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Pr(this._path)}}class j extends pn{constructor(e,t){super(e,t,new Bt,!1)}get parent(){const e=ks(this._path);return e===null?null:new j(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class st{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new I(e),s=Me(this.ref,e);return new st(this._node.getChild(t),s,S)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new st(i,Me(this.ref,s),S)))}hasChild(e){const t=new I(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function ta(n,e){return n=_e(n),n._checkNotDeleted("ref"),e!==void 0?Me(n._root,e):n._root}function Me(n,e){return n=_e(n),m(n._path)===null?gl("child","path",e):ai("child","path",e),new j(n._repo,N(n._path,e))}function na(n,e){n=_e(n),cn("push",n._path),li("push",e,n._path,!0);const t=ui(n._repo),s=Ll(t),i=Me(n,s),r=Me(n,s);let o;return o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function sa(n){return cn("remove",n._path),ql(n,null)}function ql(n,e){n=_e(n),cn("set",n._path),li("set",e,n._path,!1);const t=new Ot;return Sl(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}class gn{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new Fl("value",this,new st(e.snapshotNode,new j(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Wl(this,e,t):null}matches(e){return e instanceof gn?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Gl(n,e,t,s,i){const r=new Ul(t,void 0),o=new gn(r);return Rl(n._repo,n,o),()=>bl(n._repo,n,o)}function ia(n,e,t,s){return Gl(n,"value",e)}Ho(j);Ko(j);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hl="FIREBASE_DATABASE_EMULATOR_HOST",At={};let Vl=!1;function Bl(n,e,t,s){const i=e.lastIndexOf(":"),r=e.substring(0,i),o=ns(r);n.repoInfo_=new ys(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),s&&(n.authTokenProvider_=s)}function Yl(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||V("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),A("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Zn(r,i),l=o.repoInfo,a;typeof process<"u"&&vn&&(a=vn[Hl]),a?(r=`http://${a}?ns=${l.namespace}`,o=Zn(r,i),l=o.repoInfo):o.repoInfo.secure;const c=new rr(n.name,n.options,e);ml("Invalid Firebase Database URL",o),v(o.path)||V("Database URL must point to the root of a Firebase Database (not including a child path).");const h=zl(l,n,c,new ir(n,t));return new Kl(h,n)}function Ql(n,e){const t=At[e];(!t||t[n.key]!==n)&&V(`Database ${e}(${n.repoInfo_}) has already been deleted.`),kl(n),delete t[n.key]}function zl(n,e,t,s){let i=At[e.name];i||(i={},At[e.name]=i);let r=i[n.toURLString()];return r&&V("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new Il(n,Vl,t,s),i[n.toURLString()]=r,r}class Kl{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(Tl(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new j(this._repo,C())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Ql(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&V("Cannot call "+e+" on a deleted database.")}}function ra(n=Ei(),e){const t=Ii(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=Oi("database");s&&jl(t,...s)}return t}function jl(n,e,t,s={}){n=_e(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&Li(s,r.repoInfo_.emulatorOptions))return;V("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)s.mockUserToken&&V('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Ve(Ve.OWNER);else if(s.mockUserToken){const l=typeof s.mockUserToken=="string"?s.mockUserToken:Fi(s.mockUserToken,n.app.options.projectId);o=new Ve(l)}ns(e)&&(Wi(e),Ui("Database",!0)),Bl(r,i,s,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $l(n){Hi(Ti),vi(new wi("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Yl(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),mn(Cn,En,n),mn(Cn,En,"esm2017")}H.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};H.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};$l();export{sa as a,ra as g,ia as o,na as p,ta as r,ql as s};
