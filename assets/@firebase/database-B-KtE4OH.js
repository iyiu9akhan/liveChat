import{_ as Ci,r as mn,a as Ei,g as Ii,b as Ti,S as wi}from"./app-CHo1YO-Z.js";import{C as Si}from"./component-BFrR9VSR.js";import{x as f,y as k,z as Mt,A as Y,B as he,C as Be,G as Ni,S as Ri,H as bi,I as De,J as Dt,D as Ot,q as ki,K as xi,L as Pi,r as yn,c as ts,e as Ai,h as _e,M as Mi,N as it,O as Di,P as Oi,Q as Li,d as Fi,R as Wi,m as ns,p as Ui,u as qi}from"./util-D3hzesmL.js";import{L as Gi,a as Hi}from"./logger-CNz1B4Yj.js";var vn={};const Cn="@firebase/database",En="1.0.19";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yi{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(e,t){t==null?delete this.cache_[e]:this.cache_[e]=t}get(e){return Y(this.cache_,e)?this.cache_[e]:null}remove(e){delete this.cache_[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=function(n){try{if(typeof window<"u"&&typeof window[n]<"u"){const e=window[n];return e.setItem("firebase:sentinel","cache"),e.removeItem("firebase:sentinel"),new Bi(e)}}catch{}return new Yi},X=is("localStorage"),Qi=is("sessionStorage");/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rr{constructor(e,t){this.appCheckProvider=t,this.appName=e.name,Ei(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t==null?void 0:t.getImmediate({optional:!0}),this.appCheck||t==null||t.get().then(s=>this.appCheck=s)}getToken(e){if(this.serverAppAppCheckToken){if(e)throw new Error("Attempted reuse of `FirebaseServerApp.appCheckToken` after previous usage failed.");return Promise.resolve({token:this.serverAppAppCheckToken})}return this.appCheck?this.appCheck.getToken(e):new Promise((t,s)=>{setTimeout(()=>{this.appCheck?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){var t;(t=this.appCheckProvider)===null||t===void 0||t.get().then(s=>s.addTokenListener(e))}notifyForInvalidToken(){O(`Provided AppCheck credentials for the app named "${this.appName}" are invalid. This usually indicates your app was not initialized correctly.`)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class or{constructor(e,t,s){this.appName_=e,this.firebaseOptions_=t,this.authProvider_=s,this.auth_=null,this.auth_=s.getImmediate({optional:!0}),this.auth_||s.onInit(i=>this.auth_=i)}getToken(e){return this.auth_?this.auth_.getToken(e).catch(t=>t&&t.code==="auth/token-not-initialized"?(A("Got auth/token-not-initialized error.  Treating as null token."),null):Promise.reject(t)):new Promise((t,s)=>{setTimeout(()=>{this.auth_?this.getToken(e).then(t,s):t(null)},0)})}addTokenChangeListener(e){this.auth_?this.auth_.addAuthTokenListener(e):this.authProvider_.get().then(t=>t.addAuthTokenListener(e))}removeTokenChangeListener(e){this.authProvider_.get().then(t=>t.removeAuthTokenListener(e))}notifyForInvalidToken(){let e='Provided authentication credentials for the app named "'+this.appName_+'" are invalid. This usually indicates your app was not initialized correctly. ';"credential"in this.firebaseOptions_?e+='Make sure the "credential" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':"serviceAccount"in this.firebaseOptions_?e+='Make sure the "serviceAccount" property provided to initializeApp() is authorized to access the specified "databaseURL" and is from the correct project.':e+='Make sure the "apiKey" and "databaseURL" properties provided to initializeApp() match the values provided for your app at https://console.firebase.google.com/.',O(e)}}class Ve{constructor(e){this.accessToken=e}getToken(e){return Promise.resolve({accessToken:this.accessToken})}addTokenChangeListener(e){e(this.accessToken)}removeTokenChangeListener(e){}notifyForInvalidToken(){}}Ve.OWNER="owner";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ar{constructor(){this.counters_={}}incrementCounter(e,t=1){Y(this.counters_,e)||(this.counters_[e]=0),this.counters_[e]+=t}get(){return Mi(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t={},pt={};function Wt(n){const e=n.toString();return _t[e]||(_t[e]=new ar),_t[e]}function cr(n,e){const t=n.toString();return pt[t]||(pt[t]=e()),pt[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{constructor(e){this.onMessage_=e,this.pendingResponses=[],this.currentResponseNum=0,this.closeAfterResponse=-1,this.onClose=null}closeAfter(e,t){this.closeAfterResponse=e,this.onClose=t,this.closeAfterResponse<this.currentResponseNum&&(this.onClose(),this.onClose=null)}handleResponse(e,t){for(this.pendingResponses[e]=t;this.pendingResponses[this.currentResponseNum];){const s=this.pendingResponses[this.currentResponseNum];delete this.pendingResponses[this.currentResponseNum];for(let i=0;i<s.length;++i)s[i]&&ge(()=>{this.onMessage_(s[i])});if(this.currentResponseNum===this.closeAfterResponse){this.onClose&&(this.onClose(),this.onClose=null);break}this.currentResponseNum++}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wn="start",ur="close",dr="pLPCommand",fr="pRTLPCB",Cs="id",Es="pw",Is="ser",_r="cb",pr="seg",gr="ts",mr="d",yr="dframe",Ts=1870,ws=30,vr=Ts-ws,Cr=25e3,Er=3e4;class oe{constructor(e,t,s,i,r,o,l){this.connId=e,this.repoInfo=t,this.applicationId=s,this.appCheckToken=i,this.authToken=r,this.transportSessionId=o,this.lastSessionId=l,this.bytesSent=0,this.bytesReceived=0,this.everConnected_=!1,this.log_=Le(e),this.stats_=Wt(t),this.urlFn=a=>(this.appCheckToken&&(a[It]=this.appCheckToken),vs(t,ms,a))}open(e,t){this.curSegmentNum=0,this.onDisconnect_=t,this.myPacketOrderer=new hr(e),this.isClosed_=!1,this.connectTimeoutTimer_=setTimeout(()=>{this.log_("Timed out trying to connect."),this.onClosed_(),this.connectTimeoutTimer_=null},Math.floor(Er)),$i(()=>{if(this.isClosed_)return;this.scriptTagHolder=new Ut((...r)=>{const[o,l,a,c,h]=r;if(this.incrementIncomingBytes_(r),!!this.scriptTagHolder)if(this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null),this.everConnected_=!0,o===wn)this.id=l,this.password=a;else if(o===ur)l?(this.scriptTagHolder.sendNewPolls=!1,this.myPacketOrderer.closeAfter(l,()=>{this.onClosed_()})):this.onClosed_();else throw new Error("Unrecognized command received: "+o)},(...r)=>{const[o,l]=r;this.incrementIncomingBytes_(r),this.myPacketOrderer.handleResponse(o,l)},()=>{this.onClosed_()},this.urlFn);const s={};s[wn]="t",s[Is]=Math.floor(Math.random()*1e8),this.scriptTagHolder.uniqueCallbackIdentifier&&(s[_r]=this.scriptTagHolder.uniqueCallbackIdentifier),s[cs]=Ft,this.transportSessionId&&(s[hs]=this.transportSessionId),this.lastSessionId&&(s[_s]=this.lastSessionId),this.applicationId&&(s[ps]=this.applicationId),this.appCheckToken&&(s[It]=this.appCheckToken),typeof location<"u"&&location.hostname&&fs.test(location.hostname)&&(s[us]=ds);const i=this.urlFn(s);this.log_("Connecting via long-poll to "+i),this.scriptTagHolder.addTag(i,()=>{})})}start(){this.scriptTagHolder.startLongPoll(this.id,this.password),this.addDisconnectPingFrame(this.id,this.password)}static forceAllow(){oe.forceAllow_=!0}static forceDisallow(){oe.forceDisallow_=!0}static isAvailable(){return oe.forceAllow_?!0:!oe.forceDisallow_&&typeof document<"u"&&document.createElement!=null&&!Ji()&&!Zi()}markConnectionHealthy(){}shutdown_(){this.isClosed_=!0,this.scriptTagHolder&&(this.scriptTagHolder.close(),this.scriptTagHolder=null),this.myDisconnFrame&&(document.body.removeChild(this.myDisconnFrame),this.myDisconnFrame=null),this.connectTimeoutTimer_&&(clearTimeout(this.connectTimeoutTimer_),this.connectTimeoutTimer_=null)}onClosed_(){this.isClosed_||(this.log_("Longpoll is closing itself"),this.shutdown_(),this.onDisconnect_&&(this.onDisconnect_(this.everConnected_),this.onDisconnect_=null))}close(){this.isClosed_||(this.log_("Longpoll is being closed."),this.shutdown_())}send(e){const t=k(e);this.bytesSent+=t.length,this.stats_.incrementCounter("bytes_sent",t.length);const s=Di(t),i=ls(s,vr);for(let r=0;r<i.length;r++)this.scriptTagHolder.enqueueSegment(this.curSegmentNum,i.length,i[r]),this.curSegmentNum++}addDisconnectPingFrame(e,t){this.myDisconnFrame=document.createElement("iframe");const s={};s[yr]="t",s[Cs]=e,s[Es]=t,this.myDisconnFrame.src=this.urlFn(s),this.myDisconnFrame.style.display="none",document.body.appendChild(this.myDisconnFrame)}incrementIncomingBytes_(e){const t=k(e).length;this.bytesReceived+=t,this.stats_.incrementCounter("bytes_received",t)}}class Ut{constructor(e,t,s,i){this.onDisconnect=s,this.urlFn=i,this.outstandingRequests=new Set,this.pendingSegs=[],this.currentSerial=Math.floor(Math.random()*1e8),this.sendNewPolls=!0;{this.uniqueCallbackIdentifier=zi(),window[dr+this.uniqueCallbackIdentifier]=e,window[fr+this.uniqueCallbackIdentifier]=t,this.myIFrame=Ut.createIFrame_();let r="";this.myIFrame.src&&this.myIFrame.src.substr(0,11)==="javascript:"&&(r='<script>document.domain="'+document.domain+'";<\/script>');const o="<html><body>"+r+"</body></html>";try{this.myIFrame.doc.open(),this.myIFrame.doc.write(o),this.myIFrame.doc.close()}catch(l){A("frame writing exception"),l.stack&&A(l.stack),A(l)}}}static createIFrame_(){const e=document.createElement("iframe");if(e.style.display="none",document.body){document.body.appendChild(e);try{e.contentWindow.document||A("No IE domain setting required")}catch{const s=document.domain;e.src="javascript:void((function(){document.open();document.domain='"+s+"';document.close();})())"}}else throw"Document body has not initialized. Wait to initialize Firebase until after the document is ready.";return e.contentDocument?e.doc=e.contentDocument:e.contentWindow?e.doc=e.contentWindow.document:e.document&&(e.doc=e.document),e}close(){this.alive=!1,this.myIFrame&&(this.myIFrame.doc.body.textContent="",setTimeout(()=>{this.myIFrame!==null&&(document.body.removeChild(this.myIFrame),this.myIFrame=null)},Math.floor(0)));const e=this.onDisconnect;e&&(this.onDisconnect=null,e())}startLongPoll(e,t){for(this.myID=e,this.myPW=t,this.alive=!0;this.newRequest_(););}newRequest_(){if(this.alive&&this.sendNewPolls&&this.outstandingRequests.size<(this.pendingSegs.length>0?2:1)){this.currentSerial++;const e={};e[Cs]=this.myID,e[Es]=this.myPW,e[Is]=this.currentSerial;let t=this.urlFn(e),s="",i=0;for(;this.pendingSegs.length>0&&this.pendingSegs[0].d.length+ws+s.length<=Ts;){const o=this.pendingSegs.shift();s=s+"&"+pr+i+"="+o.seg+"&"+gr+i+"="+o.ts+"&"+mr+i+"="+o.d,i++}return t=t+s,this.addLongPollTag_(t,this.currentSerial),!0}else return!1}enqueueSegment(e,t,s){this.pendingSegs.push({seg:e,ts:t,d:s}),this.alive&&this.newRequest_()}addLongPollTag_(e,t){this.outstandingRequests.add(t);const s=()=>{this.outstandingRequests.delete(t),this.newRequest_()},i=setTimeout(s,Math.floor(Cr)),r=()=>{clearTimeout(i),s()};this.addTag(e,r)}addTag(e,t){setTimeout(()=>{try{if(!this.sendNewPolls)return;const s=this.myIFrame.doc.createElement("script");s.type="text/javascript",s.async=!0,s.src=e,s.onload=s.onreadystatechange=function(){const i=s.readyState;(!i||i==="loaded"||i==="complete")&&(s.onload=s.onreadystatechange=null,s.parentNode&&s.parentNode.removeChild(s),t())},s.onerror=()=>{A("Long-poll script failed to load: "+e),this.sendNewPolls=!1,this.close()},this.myIFrame.doc.body.appendChild(s)}catch{}},Math.floor(1))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qe extends Ns{static getInstance(){return new Qe}constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!ts()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}getInitialEvent(e){return f(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt extends Ns{static getInstance(){return new Gt}constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}getInitialEvent(e){return f(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ge;class Ps extends rt{static get __EMPTY_NODE(){return Ge}static set __EMPTY_NODE(e){Ge=e}compare(e,t){return pe(e.name,t.name)}isDefinedOn(e){throw De("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return y.MIN}maxPost(){return new y(Z,Ge)}makePost(e,t){return f(typeof e=="string","KeyIndex indexValue must always be a string."),new y(e,Ge)}toString(){return".key"}}const ae=new Ps;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gr(n,e){return pe(n.name,e.name)}function Ht(n,e){return pe(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ds,Os;function Vr(n){Ds=n}function Br(n){Os=n}class Yr extends rt{compare(e,t){const s=e.node.getPriority(),i=t.node.getPriority(),r=s.compareTo(i);return r===0?pe(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return y.MIN}maxPost(){return new y(Z,new R("[PRIORITY-POST]",Os))}makePost(e,t){const s=Ds(e);return new y(t,new R("[PRIORITY-POST]",s))}toString(){return".priority"}}const S=new Yr;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qr=Math.log(2);class zr{constructor(e){const t=r=>parseInt(Math.log(r)/Qr,10),s=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const i=s(this.count);this.bits_=e+1&i}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const ze=function(n,e,t,s){n.sort(e);const i=function(a,c){const h=c-a;let u,d;if(h===0)return null;if(h===1)return u=n[a],d=t?t(u):u,new b(d,u.node,b.BLACK,null,null);{const _=parseInt(h/2,10)+a,p=i(a,_),E=i(_+1,c);return u=n[_],d=t?t(u):u,new b(d,u.node,b.BLACK,p,E)}},r=function(a){let c=null,h=null,u=n.length;const d=function(p,E){const P=u-p,ie=u;u-=p;const qe=i(P+1,ie),ft=n[P],vi=t?t(ft):ft;_(new b(vi,ft.node,E,null,qe))},_=function(p){c?(c.left=p,c=p):(h=p,c=p)};for(let p=0;p<a.count;++p){const E=a.nextBitIsOne(),P=Math.pow(2,a.count-(p+1));E?d(P,b.BLACK):(d(P,b.BLACK),d(P,b.RED))}return h},o=new zr(n.length),l=r(o);return new D(s||e,l)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let mt;const re={};class G{static get Default(){return f(re&&S,"ChildrenNode.ts has not been loaded"),mt=mt||new G({".priority":re},{".priority":S}),mt}constructor(e,t){this.indexes_=e,this.indexSet_=t}get(e){const t=he(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof D?t:null}hasIndex(e){return Y(this.indexSet_,e.toString())}addIndex(e,t){f(e!==ae,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const s=[];let i=!1;const r=t.getIterator(y.Wrap);let o=r.getNext();for(;o;)i=i||e.isDefinedOn(o.node),s.push(o),o=r.getNext();let l;i?l=ze(s,e.getCompare()):l=re;const a=e.toString(),c=Object.assign({},this.indexSet_);c[a]=e;const h=Object.assign({},this.indexes_);return h[a]=l,new G(h,c)}addToIndexes(e,t){const s=Be(this.indexes_,(i,r)=>{const o=he(this.indexSet_,r);if(f(o,"Missing index implementation for "+r),i===re)if(o.isDefinedOn(e.node)){const l=[],a=t.getIterator(y.Wrap);let c=a.getNext();for(;c;)c.name!==e.name&&l.push(c),c=a.getNext();return l.push(e),ze(l,o.getCompare())}else return re;else{const l=t.get(e.name);let a=i;return l&&(a=a.remove(new y(e.name,l))),a.insert(e,e.node)}});return new G(s,this.indexSet_)}removeFromIndexes(e,t){const s=Be(this.indexes_,i=>{if(i===re)return i;{const r=t.get(e.name);return r?i.remove(new y(e.name,r)):i}});return new G(s,this.indexSet_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jr=!0;function x(n,e=null){if(n===null)return g.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),f(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new R(t,x(e))}if(!(n instanceof Array)&&jr){const t=[];let s=!1;if(L(n,(o,l)=>{if(o.substring(0,1)!=="."){const a=x(l);a.isEmpty()||(s=s||!a.getPriority().isEmpty(),t.push(new y(o,a)))}}),t.length===0)return g.EMPTY_NODE;const r=ze(t,Gr,o=>o.name,Ht);if(s){const o=ze(t,S.getCompare());return new g(r,x(e),new G({".priority":o},{".priority":S}))}else return new g(r,x(e),G.Default)}else{let t=g.EMPTY_NODE;return L(n,(s,i)=>{if(Y(n,s)&&s.substring(0,1)!=="."){const r=x(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(s,r))}}),t.updatePriority(x(e))}}Vr(x);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xr extends rt{compare(e,t){const s=e.node.compareTo(t.node);return s===0?pe(e.name,t.name):s}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return y.MIN}maxPost(){return y.MAX}makePost(e,t){const s=x(e);return new y(t,s)}toString(){return".value"}}const Jr=new Xr;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ls(n){return{type:"value",snapshotNode:n}}function de(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function be(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function ke(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Zr(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){f(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const l=e.getImmediateChild(t);return l.getChild(i).equals(s.getChild(i))&&l.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(be(t,l)):f(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):l.isEmpty()?o.trackChildChange(de(t,s)):o.trackChildChange(ke(t,s,l))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(S,(i,r)=>{t.hasChild(i)||s.trackChildChange(be(i,r))}),t.isLeafNode()||t.forEachChild(S,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(ke(i,r,o))}else s.trackChildChange(de(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?g.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class io{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&L(this.last_,(s,i)=>{t[s]=t[s]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wn=10*1e3,ro=30*1e3,oo=5*60*1e3;class lo{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new io(e);const s=Wn+(ro-Wn)*Math.random();Te(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;L(e,(i,r)=>{r>0&&Y(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),Te(this.reportStats_.bind(this),Math.floor(Math.random()*2*oo))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function co(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Zr(o.childName,o.snapshotNode))}),Ee(n,i,"child_removed",e,s,t),Ee(n,i,"child_added",e,s,t),Ee(n,i,"child_moved",r,s,t),Ee(n,i,"child_changed",e,s,t),Ee(n,i,"value",e,s,t),i}function Ee(n,e,t,s,i,r){const o=s.filter(l=>l.type===t);o.sort((l,a)=>uo(n,l,a)),o.forEach(l=>{const a=ho(n,l,r);i.forEach(c=>{c.respondsTo(l.type)&&e.push(c.createEvent(a,n.query_))})})}function ho(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function uo(n,e,t){if(e.childName==null||t.childName==null)throw De("Should only compare child_ events.");const s=new y(e.childName,e.snapshotNode),i=new y(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(n,e){return Bs(e,n)}function _o(n,e,t,s,i){f(s>n.lastWriteId,"Stacking an older write on top of newer ones"),i===void 0&&(i=!0),n.allWrites.push({path:e,snap:t,writeId:s,visible:i}),i&&(n.visibleWrites=Se(n.visibleWrites,e,t)),n.lastWriteId=s}function po(n,e){for(let t=0;t<n.allWrites.length;t++){const s=n.allWrites[t];if(s.writeId===e)return s}return null}function go(n,e){const t=n.allWrites.findIndex(l=>l.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const s=n.allWrites[t];n.allWrites.splice(t,1);let i=s.visible,r=!1,o=n.allWrites.length-1;for(;i&&o>=0;){const l=n.allWrites[o];l.visible&&(o>=t&&mo(l,s.path)?i=!1:W(s.path,l.path)&&(r=!0)),o--}if(i){if(r)return yo(n),!0;if(s.snap)n.visibleWrites=qn(n.visibleWrites,s.path);else{const l=s.children;L(l,a=>{n.visibleWrites=qn(n.visibleWrites,N(s.path,a))})}return!0}else return!1}function mo(n,e){if(n.snap)return W(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&W(N(n.path,t),e))return!0;return!1}function yo(n){n.visibleWrites=Gs(n.allWrites,vo,C()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function vo(n){return n.visible}function Gs(n,e,t){let s=q.empty();for(let i=0;i<n.length;++i){const r=n[i];if(e(r)){const o=r.path;let l;if(r.snap)W(t,o)?(l=M(t,o),s=Se(s,l,r.snap)):W(o,t)&&(l=M(o,t),s=Se(s,C(),r.snap.getChild(l)));else if(r.children){if(W(t,o))l=M(t,o),s=Un(s,l,r.children);else if(W(o,t))if(l=M(o,t),v(l))s=Un(s,C(),r.children);else{const a=he(r.children,m(l));if(a){const c=a.getChild(T(l));s=Se(s,C(),c)}}}else throw De("WriteRecord should have .snap or .children")}}return s}function Hs(n,e,t,s,i){if(!s&&!i){const r=se(n.visibleWrites,e);if(r!=null)return r;{const o=Q(n.visibleWrites,e);if(Rt(o))return t;if(t==null&&!Nt(o,C()))return null;{const l=t||g.EMPTY_NODE;return fe(o,l)}}}else{const r=Q(n.visibleWrites,e);if(!i&&Rt(r))return t;if(!i&&t==null&&!Nt(r,C()))return null;{const o=function(c){return(c.visible||i)&&(!s||!~s.indexOf(c.writeId))&&(W(c.path,e)||W(e,c.path))},l=Gs(n.allWrites,o,e),a=t||g.EMPTY_NODE;return fe(l,a)}}}function Co(n,e,t){let s=g.EMPTY_NODE;const i=se(n.visibleWrites,e);if(i)return i.isLeafNode()||i.forEachChild(S,(r,o)=>{s=s.updateImmediateChild(r,o)}),s;if(t){const r=Q(n.visibleWrites,e);return t.forEachChild(S,(o,l)=>{const a=fe(Q(r,new I(o)),l);s=s.updateImmediateChild(o,a)}),Gn(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}else{const r=Q(n.visibleWrites,e);return Gn(r).forEach(o=>{s=s.updateImmediateChild(o.name,o.node)}),s}}function Eo(n,e,t,s,i){f(s||i,"Either existingEventSnap or existingServerSnap must exist");const r=N(e,t);if(Nt(n.visibleWrites,r))return null;{const o=Q(n.visibleWrites,r);return Rt(o)?i.getChild(t):fe(o,i.getChild(t))}}function Io(n,e,t,s){const i=N(e,t),r=se(n.visibleWrites,i);if(r!=null)return r;if(s.isCompleteForChild(t)){const o=Q(n.visibleWrites,i);return fe(o,s.getNode().getImmediateChild(t))}else return null}function To(n,e){return se(n.visibleWrites,e)}function wo(n,e,t,s,i,r,o){let l;const a=Q(n.visibleWrites,e),c=se(a,C());if(c!=null)l=c;else if(t!=null)l=fe(a,t);else return[];if(l=l.withIndex(o),!l.isEmpty()&&!l.isLeafNode()){const h=[],u=o.getCompare(),d=r?l.getReverseIteratorFrom(s,o):l.getIteratorFrom(s,o);let _=d.getNext();for(;_&&h.length<i;)u(_,s)!==0&&h.push(_),_=d.getNext();return h}else return[]}function So(){return{visibleWrites:q.empty(),allWrites:[],lastWriteId:-1}}function Xe(n,e,t,s){return Hs(n.writeTree,n.treePath,e,t,s)}function Kt(n,e){return Co(n.writeTree,n.treePath,e)}function Hn(n,e,t,s){return Eo(n.writeTree,n.treePath,e,t,s)}function Je(n,e){return To(n.writeTree,N(n.treePath,e))}function No(n,e,t,s,i,r){return wo(n.writeTree,n.treePath,e,t,s,i,r)}function jt(n,e,t){return Io(n.writeTree,n.treePath,e,t)}function Vs(n,e){return Bs(N(n.treePath,e),n.writeTree)}function Bs(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bo{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const Ys=new bo;class $t{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new te(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return jt(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:ne(this.viewCache_),r=No(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fo{constructor(e,t){this.query_=e,this.eventRegistrations_=[];const s=this.query_._queryParams,i=new Vt(s.getIndex()),r=to(s);this.processor_=ko(r);const o=t.serverCache,l=t.eventCache,a=i.updateFullNode(g.EMPTY_NODE,o.getNode(),null),c=r.updateFullNode(g.EMPTY_NODE,l.getNode(),null),h=new te(a,o.isFullyInitialized(),i.filtersNodes()),u=new te(c,l.isFullyInitialized(),r.filtersNodes());this.viewCache_=ot(u,h),this.eventGenerator_=new ao(this.query_)}get query(){return this.query_}}function Wo(n){return n.viewCache_.serverCache.getNode()}function Uo(n,e){const t=ne(n.viewCache_);return t&&(n.query._queryParams.loadsAllData()||!v(e)&&!t.getImmediateChild(m(e)).isEmpty())?t.getChild(e):null}function Yn(n){return n.eventRegistrations_.length===0}function qo(n,e){n.eventRegistrations_.push(e)}function Qn(n,e,t){const s=[];if(t){f(e==null,"A cancel should cancel all event registrations.");const i=n.query._path;n.eventRegistrations_.forEach(r=>{const o=r.createCancelEvent(t,i);o&&s.push(o)})}if(e){let i=[];for(let r=0;r<n.eventRegistrations_.length;++r){const o=n.eventRegistrations_[r];if(!o.matches(e))i.push(o);else if(e.hasAnyCallback()){i=i.concat(n.eventRegistrations_.slice(r+1));break}}n.eventRegistrations_=i}else n.eventRegistrations_=[];return s}function zn(n,e,t,s){e.type===U.MERGE&&e.source.queryId!==null&&(f(ne(n.viewCache_),"We should always have a full cache before handling merges"),f(St(n.viewCache_),"Missing event cache, even though we have a server cache"));const i=n.viewCache_,r=Po(n.processor_,i,e,t,s);return xo(n.processor_,r.viewCache),f(r.viewCache.serverCache.isFullyInitialized()||!i.serverCache.isFullyInitialized(),"Once a server snap is complete, it should never go back"),n.viewCache_=r.viewCache,zs(n,r.changes,r.viewCache.eventCache.getNode(),null)}function Go(n,e){const t=n.viewCache_.eventCache,s=[];return t.getNode().isLeafNode()||t.getNode().forEachChild(S,(r,o)=>{s.push(de(r,o))}),t.isFullyInitialized()&&s.push(Ls(t.getNode())),zs(n,s,t.getNode(),e)}function zs(n,e,t,s){const i=s?[s]:n.eventRegistrations_;return co(n.eventGenerator_,e,t,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let et;class Ho{constructor(){this.views=new Map}}function Vo(n){f(!et,"__referenceConstructor has already been defined"),et=n}function Bo(){return f(et,"Reference.ts has not been loaded"),et}function Yo(n){return n.views.size===0}function Xt(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return f(r!=null,"SyncTree gave us an op for an invalid query."),zn(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(zn(o,e,t,s));return r}}function Qo(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let l=Xe(t,i?s:null),a=!1;l?a=!0:s instanceof g?(l=Kt(t,s),a=!1):(l=g.EMPTY_NODE,a=!1);const c=ot(new te(l,a,!1),new te(s,i,!1));return new Fo(e,c)}return o}function zo(n,e,t,s,i,r){const o=Qo(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),qo(o,t),Go(o,t)}function Ko(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const l=K(n);if(i==="default")for(const[a,c]of n.views.entries())o=o.concat(Qn(c,t,s)),Yn(c)&&(n.views.delete(a),c.query._queryParams.loadsAllData()||r.push(c.query));else{const a=n.views.get(i);a&&(o=o.concat(Qn(a,t,s)),Yn(a)&&(n.views.delete(i),a.query._queryParams.loadsAllData()||r.push(a.query)))}return l&&!K(n)&&r.push(new(Bo())(e._repo,e._path)),{removed:r,events:o}}function Ks(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function ce(n,e){let t=null;for(const s of n.views.values())t=t||Uo(s,e);return t}function js(n,e){if(e._queryParams.loadsAllData())return lt(n);{const s=e._queryIdentifier;return n.views.get(s)}}function $s(n,e){return js(n,e)!=null}function K(n){return lt(n)!=null}function lt(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tt;function jo(n){f(!tt,"__referenceConstructor has already been defined"),tt=n}function $o(){return f(tt,"Reference.ts has not been loaded"),tt}let Xo=1;class Kn{constructor(e){this.listenProvider_=e,this.syncPointTree_=new w(null),this.pendingWriteTree_=So(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Xs(n,e,t,s,i){return _o(n.pendingWriteTree_,e,t,s,i),i?We(n,new ee(Ws(),e,t)):[]}function J(n,e,t=!1){const s=po(n.pendingWriteTree_,e);if(go(n.pendingWriteTree_,e)){let r=new w(null);return s.snap!=null?r=r.set(C(),!0):L(s.children,o=>{r=r.set(new I(o),!0)}),We(n,new $e(s.path,r,t))}else return[]}function at(n,e,t){return We(n,new ee(Yt(),e,t))}function Jo(n,e,t){const s=w.fromObject(t);return We(n,new Ae(Yt(),e,s))}function Zo(n,e){return We(n,new Pe(Yt(),e))}function el(n,e,t){const s=Zt(n,t);if(s){const i=en(s),r=i.path,o=i.queryId,l=M(r,e),a=new Pe(Qt(o),l);return tn(n,r,a)}else return[]}function xt(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let l=[];if(o&&(e._queryIdentifier==="default"||$s(o,e))){const a=Ko(o,e,t,s);Yo(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=a.removed;if(l=a.events,!i){const h=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(d,_)=>K(_));if(h&&!u){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const _=sl(d);for(let p=0;p<_.length;++p){const E=_[p],P=E.query,ie=ei(n,E);n.listenProvider_.startListening(Ne(P),nt(n,P),ie.hashFn,ie.onComplete)}}}!u&&c.length>0&&!s&&(h?n.listenProvider_.stopListening(Ne(e),null):c.forEach(d=>{const _=n.queryToTagMap.get(ct(d));n.listenProvider_.stopListening(Ne(d),_)}))}il(n,c)}return l}function tl(n,e,t,s){const i=Zt(n,s);if(i!=null){const r=en(i),o=r.path,l=r.queryId,a=M(o,e),c=new ee(Qt(l),a,t);return tn(n,o,c)}else return[]}function nl(n,e,t,s){const i=Zt(n,s);if(i){const r=en(i),o=r.path,l=r.queryId,a=M(o,e),c=w.fromObject(t),h=new Ae(Qt(l),a,c);return tn(n,o,h)}else return[]}function jn(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(d,_)=>{const p=M(d,i);r=r||ce(_,p),o=o||K(_)});let l=n.syncPointTree_.get(i);l?(o=o||K(l),r=r||ce(l,C())):(l=new Ho,n.syncPointTree_=n.syncPointTree_.set(i,l));let a;r!=null?a=!0:(a=!1,r=g.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((_,p)=>{const E=ce(p,C());E&&(r=r.updateImmediateChild(_,E))}));const c=$s(l,e);if(!c&&!e._queryParams.loadsAllData()){const d=ct(e);f(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const _=rl();n.queryToTagMap.set(d,_),n.tagToQueryMap.set(_,d)}const h=zt(n.pendingWriteTree_,i);let u=zo(l,e,t,h,r,a);if(!c&&!o&&!s){const d=js(l,e);u=u.concat(ol(n,e,d))}return u}function Jt(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,l)=>{const a=M(o,e),c=ce(l,a);if(c)return c});return Hs(i,e,r,t,!0)}function We(n,e){return Js(e,n.syncPointTree_,null,zt(n.pendingWriteTree_,C()))}function Js(n,e,t,s){if(v(n.path))return Zs(n,e,t,s);{const i=e.get(C());t==null&&i!=null&&(t=ce(i,C()));let r=[];const o=m(n.path),l=n.operationForChild(o),a=e.children.get(o);if(a&&l){const c=t?t.getImmediateChild(o):null,h=Vs(s,o);r=r.concat(Js(l,a,c,h))}return i&&(r=r.concat(Xt(i,n,s,t))),r}}function Zs(n,e,t,s){const i=e.get(C());t==null&&i!=null&&(t=ce(i,C()));let r=[];return e.children.inorderTraversal((o,l)=>{const a=t?t.getImmediateChild(o):null,c=Vs(s,o),h=n.operationForChild(o);h&&(r=r.concat(Zs(h,l,a,c)))}),i&&(r=r.concat(Xt(i,n,s,t))),r}function ei(n,e){const t=e.query,s=nt(n,t);return{hashFn:()=>(Wo(e)||g.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?el(n,t._path,s):Zo(n,t._path);{const r=er(i,t);return xt(n,t,null,r)}}}}function nt(n,e){const t=ct(e);return n.queryToTagMap.get(t)}function ct(n){return n._path.toString()+"$"+n._queryIdentifier}function Zt(n,e){return n.tagToQueryMap.get(e)}function en(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new I(n.substr(0,e))}}function tn(n,e,t){const s=n.syncPointTree_.get(e);f(s,"Missing sync point for query tag that we're tracking");const i=zt(n.pendingWriteTree_,e);return Xt(s,t,i,null)}function sl(n){return n.fold((e,t,s)=>{if(t&&K(t))return[lt(t)];{let i=[];return t&&(i=Ks(t)),L(s,(r,o)=>{i=i.concat(o)}),i}})}function Ne(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new($o())(n._repo,n._path):n}function il(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=ct(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function rl(){return Xo++}function ol(n,e,t){const s=e._path,i=nt(n,e),r=ei(n,t),o=n.listenProvider_.startListening(Ne(e),i,r.hashFn,r.onComplete),l=n.syncPointTree_.subtree(s);if(i)f(!K(l.value),"If we're adding a query, it shouldn't be shadowed");else{const a=l.fold((c,h,u)=>{if(!v(c)&&h&&K(h))return[lt(h).query];{let d=[];return h&&(d=d.concat(Ks(h).map(_=>_.query))),L(u,(_,p)=>{d=d.concat(p)}),d}});for(let c=0;c<a.length;++c){const h=a[c];n.listenProvider_.stopListening(Ne(h),nt(n,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nn{constructor(e){this.node_=e}getImmediateChild(e){const t=this.node_.getImmediateChild(e);return new nn(t)}node(){return this.node_}}class sn{constructor(e,t){this.syncTree_=e,this.path_=t}getImmediateChild(e){const t=N(this.path_,e);return new sn(this.syncTree_,t)}node(){return Jt(this.syncTree_,this.path_)}}const ll=function(n){return n=n||{},n.timestamp=n.timestamp||new Date().getTime(),n},$n=function(n,e,t){if(!n||typeof n!="object")return n;if(f(".sv"in n,"Unexpected leaf node or priority contents"),typeof n[".sv"]=="string")return al(n[".sv"],e,t);if(typeof n[".sv"]=="object")return cl(n[".sv"],e);f(!1,"Unexpected server value: "+JSON.stringify(n,null,2))},al=function(n,e,t){switch(n){case"timestamp":return t.timestamp;default:f(!1,"Unexpected server value: "+n)}},cl=function(n,e,t){n.hasOwnProperty("increment")||f(!1,"Unexpected server value: "+JSON.stringify(n,null,2));const s=n.increment;typeof s!="number"&&f(!1,"Unexpected increment value: "+s);const i=e.node();if(f(i!==null&&typeof i<"u","Expected ChildrenNode.EMPTY_NODE for nulls"),!i.isLeafNode())return s;const o=i.getValue();return typeof o!="number"?s:o+s},hl=function(n,e,t,s){return rn(e,new sn(t,n),s)},ti=function(n,e,t){return rn(n,new nn(e),t)};function rn(n,e,t){const s=n.getPriority().val(),i=$n(s,e.getImmediateChild(".priority"),t);let r;if(n.isLeafNode()){const o=n,l=$n(o.getValue(),e,t);return l!==o.getValue()||i!==o.getPriority().val()?new R(l,x(i)):n}else{const o=n;return r=o,i!==o.getPriority().val()&&(r=r.updatePriority(new R(i))),o.forEachChild(S,(l,a)=>{const c=rn(a,e.getImmediateChild(l),t);c!==a&&(r=r.updateImmediateChild(l,c))}),r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _l=/[\[\].#$\/\u0000-\u001F\u007F]/,pl=/[\[\].#$\u0000-\u001F\u007F]/,vt=10*1024*1024,ri=function(n){return typeof n=="string"&&n.length!==0&&!_l.test(n)},oi=function(n){return typeof n=="string"&&n.length!==0&&!pl.test(n)},gl=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),oi(n)},li=function(n,e,t,s){s&&e===void 0||an(Dt(n,"value"),e,t)},an=function(n,e,t){const s=t instanceof I?new Mr(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+$(s));if(typeof e=="function")throw new Error(n+"contains a function "+$(s)+" with contents = "+e.toString());if(os(e))throw new Error(n+"contains "+e.toString()+" "+$(s));if(typeof e=="string"&&e.length>vt/3&&it(e)>vt)throw new Error(n+"contains a string greater than "+vt+" utf8 bytes "+$(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(L(e,(o,l)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!ri(o)))throw new Error(n+" contains an invalid key ("+o+") "+$(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);Dr(s,o),an(n,l,s),Or(s)}),i&&r)throw new Error(n+' contains ".value" child '+$(s)+" in addition to actual children.")}},ai=function(n,e,t,s){if(!oi(t))throw new Error(Dt(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},ml=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),ai(n,e,t)},cn=function(n,e){if(m(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},yl=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!ri(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!gl(t))throw new Error(Dt(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vl{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function hn(n,e){let t=null;for(let s=0;s<e.length;s++){const i=e[s],r=i.getPath();t!==null&&!qt(r,t.path)&&(n.eventLists_.push(t),t=null),t===null&&(t={events:[],path:r}),t.events.push(i)}t&&n.eventLists_.push(t)}function ci(n,e,t){hn(n,t),hi(n,s=>qt(s,e))}function B(n,e,t){hn(n,t),hi(n,s=>W(s,e)||W(e,s))}function hi(n,e){n.recursionDepth_++;let t=!0;for(let s=0;s<n.eventLists_.length;s++){const i=n.eventLists_[s];if(i){const r=i.path;e(r)?(Cl(n.eventLists_[s]),n.eventLists_[s]=null):t=!1}}t&&(n.eventLists_=[]),n.recursionDepth_--}function Cl(n){for(let e=0;e<n.events.length;e++){const t=n.events[e];if(t!==null){n.events[e]=null;const s=t.getEventRunner();Ie&&A("event: "+t.toString()),ge(s)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const El="repo_interrupt",Il=25;class Tl{constructor(e,t,s,i){this.repoInfo_=e,this.forceRestClient_=t,this.authTokenProvider_=s,this.appCheckProvider_=i,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new vl,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=je(),this.transactionQueueTree_=new on,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function wl(n,e,t){if(n.stats_=Wt(n.repoInfo_),n.forceRestClient_||ir())n.server_=new Ke(n.repoInfo_,(s,i,r,o)=>{Xn(n,s,i,r,o)},n.authTokenProvider_,n.appCheckProvider_),setTimeout(()=>Jn(n,!0),0);else{if(typeof t<"u"&&t!==null){if(typeof t!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{k(t)}catch(s){throw new Error("Invalid authOverride provided: "+s)}}n.persistentConnection_=new H(n.repoInfo_,e,(s,i,r,o)=>{Xn(n,s,i,r,o)},s=>{Jn(n,s)},s=>{Sl(n,s)},n.authTokenProvider_,n.appCheckProvider_,t),n.server_=n.persistentConnection_}n.authTokenProvider_.addTokenChangeListener(s=>{n.server_.refreshAuthToken(s)}),n.appCheckProvider_.addTokenChangeListener(s=>{n.server_.refreshAppCheckToken(s.token)}),n.statsReporter_=cr(n.repoInfo_,()=>new lo(n.stats_,n.server_)),n.infoData_=new no,n.infoSyncTree_=new Kn({startListening:(s,i,r,o)=>{let l=[];const a=n.infoData_.getNode(s._path);return a.isEmpty()||(l=at(n.infoSyncTree_,s._path,a),setTimeout(()=>{o("ok")},0)),l},stopListening:()=>{}}),dn(n,"connected",!1),n.serverSyncTree_=new Kn({startListening:(s,i,r,o)=>(n.server_.listen(s,r,i,(l,a)=>{const c=o(l,a);B(n.eventQueue_,s._path,c)}),[]),stopListening:(s,i)=>{n.server_.unlisten(s,i)}})}function ui(n){const t=n.infoData_.getNode(new I(".info/serverTimeOffset")).val()||0;return new Date().getTime()+t}function un(n){return ll({timestamp:ui(n)})}function Xn(n,e,t,s,i){n.dataUpdateCount++;const r=new I(e);t=n.interceptServerDataCallback_?n.interceptServerDataCallback_(e,t):t;let o=[];if(i)if(s){const a=Be(t,c=>x(c));o=nl(n.serverSyncTree_,r,a,i)}else{const a=x(t);o=tl(n.serverSyncTree_,r,a,i)}else if(s){const a=Be(t,c=>x(c));o=Jo(n.serverSyncTree_,r,a)}else{const a=x(t);o=at(n.serverSyncTree_,r,a)}let l=r;o.length>0&&(l=ut(n,r)),B(n.eventQueue_,l,o)}function Jn(n,e){dn(n,"connected",e),e===!1&&Rl(n)}function Sl(n,e){L(e,(t,s)=>{dn(n,t,s)})}function dn(n,e,t){const s=new I("/.info/"+e),i=x(t);n.infoData_.updateSnapshot(s,i);const r=at(n.infoSyncTree_,s,i);B(n.eventQueue_,s,r)}function di(n){return n.nextWriteId_++}function Nl(n,e,t,s,i){fn(n,"set",{path:e.toString(),value:t,priority:s});const r=un(n),o=x(t,s),l=Jt(n.serverSyncTree_,e),a=ti(o,l,r),c=di(n),h=Xs(n.serverSyncTree_,e,a,c,!0);hn(n.eventQueue_,h),n.server_.put(e.toString(),o.val(!0),(d,_)=>{const p=d==="ok";p||O("set at "+e+" failed: "+d);const E=J(n.serverSyncTree_,c,!p);B(n.eventQueue_,e,E),Pl(n,i,d,_)});const u=mi(n,e);ut(n,u),B(n.eventQueue_,u,[])}function Rl(n){fn(n,"onDisconnectEvents");const e=un(n),t=je();wt(n.onDisconnect_,C(),(i,r)=>{const o=hl(i,r,n.serverSyncTree_,e);Fs(t,i,o)});let s=[];wt(t,C(),(i,r)=>{s=s.concat(at(n.serverSyncTree_,i,r));const o=mi(n,i);ut(n,o)}),n.onDisconnect_=je(),B(n.eventQueue_,C(),s)}function bl(n,e,t){let s;m(e._path)===".info"?s=jn(n.infoSyncTree_,e,t):s=jn(n.serverSyncTree_,e,t),ci(n.eventQueue_,e._path,s)}function kl(n,e,t){let s;m(e._path)===".info"?s=xt(n.infoSyncTree_,e,t):s=xt(n.serverSyncTree_,e,t),ci(n.eventQueue_,e._path,s)}function xl(n){n.persistentConnection_&&n.persistentConnection_.interrupt(El)}function fn(n,...e){let t="";n.persistentConnection_&&(t=n.persistentConnection_.id+":"),A(t,...e)}function Pl(n,e,t,s){e&&ge(()=>{if(t==="ok")e(null);else{const i=(t||"error").toUpperCase();let r=i;s&&(r+=": "+s);const o=new Error(r);o.code=i,e(o)}})}function fi(n,e,t){return Jt(n.serverSyncTree_,e,t)||g.EMPTY_NODE}function _n(n,e=n.transactionQueueTree_){if(e||dt(n,e),me(e)){const t=pi(n,e);f(t.length>0,"Sending zero length transaction queue"),t.every(i=>i.status===0)&&Al(n,Ue(e),t)}else si(e)&&ht(e,t=>{_n(n,t)})}function Al(n,e,t){const s=t.map(c=>c.currentWriteId),i=fi(n,e,s);let r=i;const o=i.hash();for(let c=0;c<t.length;c++){const h=t[c];f(h.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),h.status=1,h.retryCount++;const u=M(e,h.path);r=r.updateChild(u,h.currentOutputSnapshotRaw)}const l=r.val(!0),a=e;n.server_.put(a.toString(),l,c=>{fn(n,"transaction put response",{path:a.toString(),status:c});let h=[];if(c==="ok"){const u=[];for(let d=0;d<t.length;d++)t[d].status=2,h=h.concat(J(n.serverSyncTree_,t[d].currentWriteId)),t[d].onComplete&&u.push(()=>t[d].onComplete(null,!0,t[d].currentOutputSnapshotResolved)),t[d].unwatcher();dt(n,ln(n.transactionQueueTree_,e)),_n(n,n.transactionQueueTree_),B(n.eventQueue_,e,h);for(let d=0;d<u.length;d++)ge(u[d])}else{if(c==="datastale")for(let u=0;u<t.length;u++)t[u].status===3?t[u].status=4:t[u].status=0;else{O("transaction at "+a.toString()+" failed: "+c);for(let u=0;u<t.length;u++)t[u].status=4,t[u].abortReason=c}ut(n,e)}},o)}function ut(n,e){const t=_i(n,e),s=Ue(t),i=pi(n,t);return Ml(n,i,s),s}function Ml(n,e,t){if(e.length===0)return;const s=[];let i=[];const o=e.filter(l=>l.status===0).map(l=>l.currentWriteId);for(let l=0;l<e.length;l++){const a=e[l],c=M(t,a.path);let h=!1,u;if(f(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),a.status===4)h=!0,u=a.abortReason,i=i.concat(J(n.serverSyncTree_,a.currentWriteId,!0));else if(a.status===0)if(a.retryCount>=Il)h=!0,u="maxretry",i=i.concat(J(n.serverSyncTree_,a.currentWriteId,!0));else{const d=fi(n,a.path,o);a.currentInputSnapshot=d;const _=e[l].update(d.val());if(_!==void 0){an("transaction failed: Data returned ",_,a.path);let p=x(_);typeof _=="object"&&_!=null&&Y(_,".priority")||(p=p.updatePriority(d.getPriority()));const P=a.currentWriteId,ie=un(n),qe=ti(p,d,ie);a.currentOutputSnapshotRaw=p,a.currentOutputSnapshotResolved=qe,a.currentWriteId=di(n),o.splice(o.indexOf(P),1),i=i.concat(Xs(n.serverSyncTree_,a.path,qe,a.currentWriteId,a.applyLocally)),i=i.concat(J(n.serverSyncTree_,P,!0))}else h=!0,u="nodata",i=i.concat(J(n.serverSyncTree_,a.currentWriteId,!0))}B(n.eventQueue_,t,i),i=[],h&&(e[l].status=2,function(d){setTimeout(d,Math.floor(0))}(e[l].unwatcher),e[l].onComplete&&(u==="nodata"?s.push(()=>e[l].onComplete(null,!1,e[l].currentInputSnapshot)):s.push(()=>e[l].onComplete(new Error(u),!1,null))))}dt(n,n.transactionQueueTree_);for(let l=0;l<s.length;l++)ge(s[l]);_n(n,n.transactionQueueTree_)}function _i(n,e){let t,s=n.transactionQueueTree_;for(t=m(e);t!==null&&me(s)===void 0;)s=ln(s,t),e=T(e),t=m(e);return s}function pi(n,e){const t=[];return gi(n,e,t),t.sort((s,i)=>s.order-i.order),t}function gi(n,e,t){const s=me(e);if(s)for(let i=0;i<s.length;i++)t.push(s[i]);ht(e,i=>{gi(n,i,t)})}function dt(n,e){const t=me(e);if(t){let s=0;for(let i=0;i<t.length;i++)t[i].status!==2&&(t[s]=t[i],s++);t.length=s,ni(e,t.length>0?t:void 0)}ht(e,s=>{dt(n,s)})}function mi(n,e){const t=Ue(_i(n,e)),s=ln(n.transactionQueueTree_,e);return dl(s,i=>{Ct(n,i)}),Ct(n,s),ii(s,i=>{Ct(n,i)}),t}function Ct(n,e){const t=me(e);if(t){const s=[];let i=[],r=-1;for(let o=0;o<t.length;o++)t[o].status===3||(t[o].status===1?(f(r===o-1,"All SENT items should be at beginning of queue."),r=o,t[o].status=3,t[o].abortReason="set"):(f(t[o].status===0,"Unexpected transaction status in abort"),t[o].unwatcher(),i=i.concat(J(n.serverSyncTree_,t[o].currentWriteId,!0)),t[o].onComplete&&s.push(t[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?ni(e,void 0):t.length=r+1,B(n.eventQueue_,Ue(e),i);for(let o=0;o<s.length;o++)ge(s[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dl(n){let e="";const t=n.split("/");for(let s=0;s<t.length;s++)if(t[s].length>0){let i=t[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function Ol(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const s=t.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):O(`Invalid query segment '${t}' in query '${n}'`)}return e}const Zn=function(n,e){const t=Ll(n),s=t.namespace;t.domain==="firebase.com"&&V(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&t.domain!=="localhost"&&V("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||ji();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new ys(t.host,t.secure,s,i,e,"",s!==t.subdomain),path:new I(t.pathString)}},Ll=function(n){let e="",t="",s="",i="",r="",o=!0,l="https",a=443;if(typeof n=="string"){let c=n.indexOf("//");c>=0&&(l=n.substring(0,c-1),n=n.substring(c+2));let h=n.indexOf("/");h===-1&&(h=n.length);let u=n.indexOf("?");u===-1&&(u=n.length),e=n.substring(0,Math.min(h,u)),h<u&&(i=Dl(n.substring(h,u)));const d=Ol(n.substring(Math.min(n.length,u)));c=e.indexOf(":"),c>=0?(o=l==="https"||l==="wss",a=parseInt(e.substring(c+1),10)):c=e.length;const _=e.slice(0,c);if(_.toLowerCase()==="localhost")t="localhost";else if(_.split(".").length<=2)t=_;else{const p=e.indexOf(".");s=e.substring(0,p).toLowerCase(),t=e.substring(p+1),r=s}"ns"in d&&(r=d.ns)}return{host:e,port:a,domain:t,subdomain:s,secure:o,scheme:l,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wl{constructor(e,t,s,i){this.eventType=e,this.eventRegistration=t,this.snapshot=s,this.prevName=i}getPath(){const e=this.snapshot.ref;return this.eventType==="value"?e._path:e.parent._path}getEventType(){return this.eventType}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.getPath().toString()+":"+this.eventType+":"+k(this.snapshot.exportVal())}}class Ul{constructor(e,t,s){this.eventRegistration=e,this.error=t,this.path=s}getPath(){return this.path}getEventType(){return"cancel"}getEventRunner(){return this.eventRegistration.getEventRunner(this)}toString(){return this.path.toString()+":cancel"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pn{constructor(e,t,s,i){this._repo=e,this._path=t,this._queryParams=s,this._orderByCalled=i}get key(){return v(this._path)?null:Rs(this._path)}get ref(){return new j(this._repo,this._path)}get _queryIdentifier(){const e=Fn(this._queryParams),t=Lt(e);return t==="{}"?"default":t}get _queryObject(){return Fn(this._queryParams)}isEqual(e){if(e=_e(e),!(e instanceof pn))return!1;const t=this._repo===e._repo,s=qt(this._path,e._path),i=this._queryIdentifier===e._queryIdentifier;return t&&s&&i}toJSON(){return this.toString()}toString(){return this._repo.toString()+Ar(this._path)}}class j extends pn{constructor(e,t){super(e,t,new Bt,!1)}get parent(){const e=ks(this._path);return e===null?null:new j(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class st{constructor(e,t,s){this._node=e,this.ref=t,this._index=s}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const t=new I(e),s=Me(this.ref,e);return new st(this._node.getChild(t),s,S)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(s,i)=>e(new st(i,Me(this.ref,s),S)))}hasChild(e){const t=new I(e);return!this._node.getChild(t).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function ta(n,e){return n=_e(n),n._checkNotDeleted("ref"),e!==void 0?Me(n._root,e):n._root}function Me(n,e){return n=_e(n),m(n._path)===null?ml("child","path",e):ai("child","path",e),new j(n._repo,N(n._path,e))}function na(n,e){n=_e(n),cn("push",n._path),li("push",e,n._path,!0);const t=ui(n._repo),s=Fl(t),i=Me(n,s),r=Me(n,s);let o;return e!=null?o=yi(r,e).then(()=>r):o=Promise.resolve(r),i.then=o.then.bind(o),i.catch=o.then.bind(o,void 0),i}function sa(n){return cn("remove",n._path),yi(n,null)}function yi(n,e){n=_e(n),cn("set",n._path),li("set",e,n._path,!1);const t=new Ot;return Nl(n._repo,n._path,e,null,t.wrapCallback(()=>{})),t.promise}class gn{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,t){const s=t._queryParams.getIndex();return new Wl("value",this,new st(e.snapshotNode,new j(t._repo,t._path),s))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,t){return this.callbackContext.hasCancelCallback?new Ul(this,e,t):null}matches(e){return e instanceof gn?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}function Gl(n,e,t,s,i){const r=new ql(t,void 0),o=new gn(r);return bl(n._repo,n,o),()=>kl(n._repo,n,o)}function ia(n,e,t,s){return Gl(n,"value",e)}Vo(j);jo(j);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hl="FIREBASE_DATABASE_EMULATOR_HOST",At={};let Vl=!1;function Bl(n,e,t,s){const i=e.lastIndexOf(":"),r=e.substring(0,i),o=ns(r);n.repoInfo_=new ys(e,o,n.repoInfo_.namespace,n.repoInfo_.webSocketOnly,n.repoInfo_.nodeAdmin,n.repoInfo_.persistenceKey,n.repoInfo_.includeNamespaceInQueryParams,!0,t),s&&(n.authTokenProvider_=s)}function Yl(n,e,t,s,i){let r=s||n.options.databaseURL;r===void 0&&(n.options.projectId||V("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),A("Using default host for project ",n.options.projectId),r=`${n.options.projectId}-default-rtdb.firebaseio.com`);let o=Zn(r,i),l=o.repoInfo,a;typeof process<"u"&&vn&&(a=vn[Hl]),a?(r=`http://${a}?ns=${l.namespace}`,o=Zn(r,i),l=o.repoInfo):o.repoInfo.secure;const c=new or(n.name,n.options,e);yl("Invalid Firebase Database URL",o),v(o.path)||V("Database URL must point to the root of a Firebase Database (not including a child path).");const h=zl(l,n,c,new rr(n,t));return new Kl(h,n)}function Ql(n,e){const t=At[e];(!t||t[n.key]!==n)&&V(`Database ${e}(${n.repoInfo_}) has already been deleted.`),xl(n),delete t[n.key]}function zl(n,e,t,s){let i=At[e.name];i||(i={},At[e.name]=i);let r=i[n.toURLString()];return r&&V("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),r=new Tl(n,Vl,t,s),i[n.toURLString()]=r,r}class Kl{constructor(e,t){this._repoInternal=e,this.app=t,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(wl(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new j(this._repo,C())),this._rootInternal}_delete(){return this._rootInternal!==null&&(Ql(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(e){this._rootInternal===null&&V("Cannot call "+e+" on a deleted database.")}}function ra(n=Ii(),e){const t=Ti(n,"database").getImmediate({identifier:e});if(!t._instanceStarted){const s=Li("database");s&&jl(t,...s)}return t}function jl(n,e,t,s={}){n=_e(n),n._checkNotDeleted("useEmulator");const i=`${e}:${t}`,r=n._repoInternal;if(n._instanceStarted){if(i===n._repoInternal.repoInfo_.host&&Fi(s,r.repoInfo_.emulatorOptions))return;V("connectDatabaseEmulator() cannot initialize or alter the emulator configuration after the database instance has started.")}let o;if(r.repoInfo_.nodeAdmin)s.mockUserToken&&V('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Ve(Ve.OWNER);else if(s.mockUserToken){const l=typeof s.mockUserToken=="string"?s.mockUserToken:Wi(s.mockUserToken,n.app.options.projectId);o=new Ve(l)}ns(e)&&(Ui(e),qi("Database",!0)),Bl(r,i,s,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $l(n){Vi(wi),Ci(new Si("database",(e,{instanceIdentifier:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Yl(s,i,r,t)},"PUBLIC").setMultipleInstances(!0)),mn(Cn,En,n),mn(Cn,En,"esm2017")}H.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};H.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};$l();export{sa as a,ra as g,ia as o,na as p,ta as r,yi as s};
